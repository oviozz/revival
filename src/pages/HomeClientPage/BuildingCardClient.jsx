...
function BuildingCardClient({ building }) {
    ...
    return (
        <div className="lg:max-w-[470px] w-full bg-white border border-gray-200 rounded-lg overflow-hidden shadow  ">
            ...
            <div className="p-5">
                ...
                <Link to={"/home/detail"}>
                    <button
                        onClick={handleDisplayDetails} className=" w-full inline-flex items-center justify-center px-3 py-2 mt-4 text-sm font-medium text-white bg-[#146CA3] rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
...
export default BuildingCardClient;